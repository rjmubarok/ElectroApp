            ...
            <table class="table table-bordered">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td> <img src="{{asset($category->image)}}" alt="" width="70px" ; height="70px"> </td>

                  <td class=" d-flex">
                    @if ($category->status==1)
                    <a href="{{route('category.deactive',[$category->id])}}" class="btn btn-danger mr-2">Deactive</a>
                    @else

                    <a href="{{route('category.active',[$category->id])}}" class="btn btn-success mr-2">Active</a>
                    @endif
