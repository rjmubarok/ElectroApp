        ...
        <div class="card">
          <div class="card-header">
            <div class="d-flex justify-content-between">
              ...
              <a href=" {{route('sizes.create')}} " class=" btn btn-success "> Create Size</a>
            </div>
            ...
            <table class="table table-bordered">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class=" d-flex">
                    @if ($size->status==1)
                    <a href="{{route('sizes.deactive',[$size->id])}}" class="btn btn-danger mr-2">Deactive</a>
                    @else

                    <a href="{{route('sizes.active',[$size->id])}}" class="btn btn-success mr-2">Active</a>
                    @endif
                    <a href="{{ route('sizes.edit', [$size->id])}}" class="btn btn-primary btn-sm mr-1">Edit</a>
