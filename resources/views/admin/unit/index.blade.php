            ...
            <table class="table table-bordered">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class=" d-flex">
                    @if ($unit->status==1)
                    <a href="{{route('units.deactive',[$unit->id])}}" class="btn btn-danger mr-2">Deactive</a>
                    @else

                    <a href="{{route('units.active',[$unit->id])}}" class="btn btn-success mr-2">Active</a>
                    @endif
                    <a href="{{ route('units.edit', [$unit->id])}}" class="btn btn-primary btn-sm mr-1">Edit</a>
