            ...
            <table class="table table-bordered">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class=" d-flex">
                    @if ($subcategory->status==1)
                    <a href="{{route('subcategory.deactive',[$subcategory->id])}}" class="btn btn-danger mr-2">Deactive</a>
                    @else

                    <a href="{{route('subcategory.active',[$subcategory->id])}}" class="btn btn-success mr-2">Active</a>
                    @endif
                    <a href="{{ route('subcategory.edit', [$subcategory->id])}}" class="btn btn-primary btn-sm mr-1">Edit</a>
